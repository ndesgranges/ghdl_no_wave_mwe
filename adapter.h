#ifndef ADAPTER_HEADER_INCLUDED
#define ADAPTER_HEADER_INCLUDED
...
extern "C"
{
    ...
    struct ghdl_process;
    void grt_init(void);
    int grt_main_options(const char *progname, int argc, const char *const argv[]); // Updated
    int grt_main_init(void);                                                        // version
    ...
    struct ghdl_process *__ghdl_register_foreign_process(void *instance, void (*proc)(void *));
